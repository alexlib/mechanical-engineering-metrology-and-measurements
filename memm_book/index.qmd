...
## Textbook and relevant books {.unnumbered}
...
## Quick Python environment notes

Recommended Python ecosystem for training: Python 3.10+, NumPy, SciPy, Matplotlib, Pandas. To build the book, use Quarto.
...
To the extent possible under law, [the person who associated CC0]{rel="dct:publisher" resource="[_:publisher]"} with this work has waived all copyright and related or neighboring rights to this work.